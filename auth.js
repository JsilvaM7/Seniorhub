...
/* ══════════════════════════════════════════════════════════════════════════════
   SIDEBAR — definida PRIMEIRO para estar disponível imediatamente
   ══════════════════════════════════════════════════════════════════════════════ */
...
/* Exposto IMEDIATAMENTE — botão no HTML pode chamar a qualquer momento */
...
window.SeniorAuth = {
    ...
    logout() {
        ...
        else { _currentUser = null; _renderHeaderBtn(); _renderSideBarBody(); }
    }
};
...
function _renderHeaderBtn() {
    ...
    if (!user) {
        ...
        var nome   = (user.displayName || 'Usuário').split(' ')[0];
...
function _renderSideBarBody() {
    ...
    var googleSVG = '<svg width="20" height="20" viewBox="0 0 48 48" style="flex-shrink:0">' +
    ...
    if (!user) {
        ...
        var nome   = user.displayName || 'Usuário';
...
window.renderModalConteudo = function() {
    ...
    var nome = (user.displayName || 'você').split(' ')[0];
    body.innerHTML =
